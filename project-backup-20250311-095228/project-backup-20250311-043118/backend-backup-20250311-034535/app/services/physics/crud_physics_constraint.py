...
from backend.app.schemas.physics_constraint import (
    PhysicsConstraintCreate,
    PhysicsConstraintUpdate,
)


class CRUDPhysicsConstraint(
    CRUDBase[PhysicsConstraint, PhysicsConstraintCreate, PhysicsConstraintUpdate]
):
    """CRUD operations for physics constraints."""
    ...
    async def create_with_scene(
        self, db: AsyncSession, *, obj_in: PhysicsConstraintCreate
    ) -> PhysicsConstraint:
    ...
    async def get_by_type(
        self, db: AsyncSession, *, scene_id: int, constraint_type: str
    ) -> List[PhysicsConstraint]:
    ...
    async def update_limits(
        self, db: AsyncSession, *, db_obj: PhysicsConstraint, limits: Dict[str, Any]
    ) -> PhysicsConstraint:
    ...
    async def update_spring_properties(
        self, db: AsyncSession, *, db_obj: PhysicsConstraint, properties: Dict[str, Any]
    ) -> PhysicsConstraint:
    ...
    async def toggle_enabled(
        self, db: AsyncSession, *, db_obj: PhysicsConstraint
    ) -> PhysicsConstraint:

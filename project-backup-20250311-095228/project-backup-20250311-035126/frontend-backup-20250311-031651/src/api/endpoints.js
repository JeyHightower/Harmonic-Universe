...
const physicsObjectEndpoints = {
    ...
    get: (universeId, objectId) => `${API_BASE_URL}/universes/${universeId}/objects/${objectId}`,
    update: (universeId, objectId) => `${API_BASE_URL}/universes/${universeId}/objects/${objectId}`,
    delete: (universeId, objectId) => `${API_BASE_URL}/universes/${universeId}/objects/${objectId}`,
};

// Audio tracks endpoints
const audioTrackEndpoints = {
    list: (universeId) => `${API_BASE_URL}/universes/${universeId}/audio-tracks`,
    create: (universeId) => `${API_BASE_URL}/universes/${universeId}/audio-tracks`,
    get: (universeId, trackId) => `${API_BASE_URL}/universes/${universeId}/audio-tracks/${trackId}`,
    update: (universeId, trackId) => `${API_BASE_URL}/universes/${universeId}/audio-tracks/${trackId}`,
    delete: (universeId, trackId) => `${API_BASE_URL}/universes/${universeId}/audio-tracks/${trackId}`,
};

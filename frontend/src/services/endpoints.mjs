...
export const sceneEndpoints = {
  ...
  forUniverse: (universeId) => endpoint(`/scenes/universe/${safeId(universeId)}`),
...
export const characterEndpoints = {
  ...
  forUniverse: (universeId) => endpoint(`/characters/universe/${safeId(universeId)}`),
  byUniverse: (universeId) => endpoint(`/characters/universe/${safeId(universeId)}`),

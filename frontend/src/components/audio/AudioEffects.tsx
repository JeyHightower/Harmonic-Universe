import { AudioEffect, AudioEffectParameter } from '@/types/audio';
...
const AudioEffects = ({
    ...
    const renderParameter = useCallback(
        (effect: AudioEffect, param: AudioEffectParameter) => (
            <Box key={param.name} sx={{ mt: 2 }}>
                ...
                <Slider
                    ...
                    step={param.step}
                    onChange={(_, value) =>
                        handleParameterChange(effect.id, param.name, value as number)
                    }
        ...
        <Box>
            <Box sx={{ mb: 2, display: 'flex', alignItems: 'center', gap: 2 }}>
                <FormControl size="small" sx={{ minWidth: 200 }}>
                    ...
                    <Select
                        label="Add Effect"
                        onChange={(e) => handleAddEffect(e.target.value as string)}
                        value=""
                    >

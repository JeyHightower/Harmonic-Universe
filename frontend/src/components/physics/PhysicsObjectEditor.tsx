...
interface PhysicsObjectEditorProps {
    ...
    onClose: () => void;
    onSave: (objectId: number, updates: Partial<PhysicsObject>) => void;
}

export const PhysicsObjectEditor: React.FC<PhysicsObjectEditorProps> = ({
    object,
    onClose,
    onSave,
}) => {
    const [formData, setFormData] = useState<Partial<PhysicsObject>>({});
    ...
    return (
        <Dialog open={!!object} onClose={onClose} maxWidth="md" fullWidth>
            <DialogTitle>Edit Physics Object</DialogTitle>
            <DialogContent>
                <Box sx={{ pt: 2 }}>
                    <TextField
                        fullWidth

...
const LoginPage = () => {
  ...
  const handleDemoLogin = async () => {
    try {
      console.log("LoginPage - Starting demo login process");
      setLoading(true);
      setError(null);
      ...
      if (window.location.hostname.includes("render.com")) {
        console.log(
          "LoginPage - Production environment detected, creating demo user directly"
        );
      ...
      console.log("LoginPage - Dispatching demoLogin action");
      ...
      if (
        ...
        console.error(
          "LoginPage - Demo login failed, falling back to direct method"
        );
      ...
      console.error("LoginPage - Error during demo login:", error);

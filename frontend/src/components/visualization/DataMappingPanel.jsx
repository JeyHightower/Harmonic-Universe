...
const DataMappingPanel: React.FC = ({ visualization }) => {
    ...
    const handleSourceFieldChange = (event: SelectChangeEvent) => {
        setNewMapping(prev => ({
            ...prev,
    ...
    const handleTargetFieldChange = (event: SelectChangeEvent) => {
        setNewMapping(prev => ({
            ...prev,
    ...
    return (
                ...
                <Stack spacing={2}>
                    <Grid container spacing={2}>
                        ...
                        <Grid item xs={4}>
                            <FormControl fullWidth>
                                Transformation Type</InputLabel>
                                <Select

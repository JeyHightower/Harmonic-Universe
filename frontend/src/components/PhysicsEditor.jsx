...
import { 
  ...
  Button, FormControlLabel, Switch, Slider,
  Grid, Card, CardContent, Divider, Alert
} from '@mui/material';
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        response = await fetch(`${API_URL}/api/physics/2d?${entityType}_id=${entityId}`);
        ...
        response = await fetch(`${API_URL}/api/physics/3d?${entityType}_id=${entityId}`);
        ...
        response = await fetch(`${API_URL}/api/physics/objects?${entityType}_id=${entityId}`);
        ...
        if (entityType === 'scene') {
          response = await fetch(`${API_URL}/api/physics/constraints?scene_id=${entityId}`);
  ...
  return (
    <Box sx={{ width: '100%' }}>
      ...
      <TabPanel value={tabValue} index={0}>
        ...
        {is2D ? (
          <Card variant="outlined">
            <CardContent>
              <Typography variant="h6" gutterBottom>2D Physics Settings</Typography>
                ...
                <Grid container spacing={2}>
                  ...
                  <Grid item xs={12} sm={6}>
                    ...
                    <Slider
                      ...
                      onChange={(e, newValue) => 
                        setPhysics2D(prev => ({...prev, gravity_x: newValue}))}
                      min={-20}
                      max={20}
                      step={0.1}
                  ...
                  <Grid item xs={12} sm={6}>
                    ...
                    <Slider
                      ...
                      onChange={(e, newValue) => 
                        setPhysics2D(prev => ({...prev, gravity_y: newValue}))}
                      min={-20}
                      max={20}
                      step={0.1}
                      valueLabelDisplay="auto"
                  ...
                  <Grid item xs={12} sm={6}>
                    ...
                    <Slider
                      ...
                      onChange={(e, newValue) => 
                        setPhysics2D(prev => ({...prev, friction: newValue}))}
                      min={0}
                      max={1}
                      step={0.01}
                      valueLabelDisplay="auto"
                  ...
                  <Grid item xs={12} sm={6}>
                    ...
                    <Slider
                      ...
                      onChange={(e, newValue) => 
                        setPhysics2D(prev => ({...prev, restitution: newValue}))}
                      min={0}
                      max={1}
                      step={0.01}
                      valueLabelDisplay="auto"
                  ...
                  <Grid item xs={12} sm={6}>
                    ...
                    <Slider
                      ...
                      onChange={(e, newValue) => 
                        setPhysics2D(prev => ({...prev, linear_damping: newValue}))}
                      min={0}
                      max={1}
                      step={0.01}
                      valueLabelDisplay="auto"
                  ...
                  <Grid item xs={12} sm={6}>
                    ...
                    <Slider
                      ...
                      onChange={(e, newValue) => 
                        setPhysics2D(prev => ({...prev, angular_damping: newValue}))}
                      min={0}
                      max={1}
                      step={0.01}
                      valueLabelDisplay="auto"
                  ...
                  <Grid item xs={12} sm={6}>
                    ...
                    <Slider
                      ...
                      onChange={(e, newValue) => 
                        setPhysics2D(prev => ({...prev, time_scale: newValue}))}
                      min={0.1}
                      max={2}
                      step={0.1}
                      valueLabelDisplay="auto"
          ...
          <Card variant="outlined">
            <CardContent>
              <Typography variant="h6" gutterBottom>3D Physics Settings</Typography>
              ...
              {!physics3D ? (
                ...
                <Grid container spacing={2}>
                  ...
                  <Grid item xs={12}>
                    <Typography variant="subtitle1" gutterBottom>Gravity</Typography>
                  </Grid>
                  ...
                  <Grid item xs={12} sm={4}>
                    ...
                    <Slider
                      ...
                      onChange={(e, newValue) => 
                        setPhysics3D(prev => ({...prev, gravity_x: newValue}))}
                      min={-20}
                      max={20}
                      step={0.1}
                      valueLabelDisplay="auto"
                  ...
                  <Grid item xs={12} sm={4}>
                    ...
                    <Slider
                      ...
                      onChange={(e, newValue) => 
                        setPhysics3D(prev => ({...prev, gravity_y: newValue}))}
                      min={-20}
                      max={20}
                      step={0.1}
                      valueLabelDisplay="auto"
                  ...
                  <Grid item xs={12} sm={4}>
                    ...
                    <Slider
                      ...
                      onChange={(e, newValue) => 
                        setPhysics3D(prev => ({...prev, gravity_z: newValue}))}
                      min={-20}
                      max={20}
                      step={0.1}
                      valueLabelDisplay="auto"
                  ...
                  <Grid item xs={12}>
                    ...
                    <Typography variant="subtitle1" gutterBottom>Material Properties</Typography>
                  </Grid>
                  ...
                  <Grid item xs={12} sm={6}>
                    ...
                    <Slider
                      ...
                      onChange={(e, newValue) => 
                        setPhysics3D(prev => ({...prev, friction: newValue}))}
                      min={0}
                      max={1}
                      step={0.01}
                      valueLabelDisplay="auto"
                  ...
                  <Grid item xs={12} sm={6}>
                    ...
                    <Slider
                      ...
                      onChange={(e, newValue) => 
                        setPhysics3D(prev => ({...prev, restitution: newValue}))}
                      min={0}
                      max={1}
                      step={0.01}
                      valueLabelDisplay="auto"
                  ...
                  <Grid item xs={12} sm={6}>
                    ...
                    <Slider
                      ...
                      onChange={(e, newValue) => 
                        setPhysics3D(prev => ({...prev, collision_margin: newValue}))}
                      min={0}
                      max={0.1}
                      step={0.001}
                      valueLabelDisplay="auto"
                  ...
                  <Grid item xs={12} sm={6}>
                    ...
                    <Slider
                      ...
                      onChange={(e, newValue) => 
                        setPhysics3D(prev => ({...prev, time_scale: newValue}))}
                      min={0.1}
                      max={2}
                      step={0.1}
                      valueLabelDisplay="auto"
                    ...
                    <FormControlLabel
                      control={
                        <Switch 
                          ...
                          onChange={(e) => 
                            setPhysics3D(prev => ({...prev, continuous_detection: e.target.checked}))}
      ...
      <TabPanel value={tabValue} index={1}>
        <Typography variant="h6" gutterBottom>Physics Objects</Typography>
        ...
        {objects.length === 0 ? (
          <Typography>No physics objects found. Add some to enable physics interactions.</Typography>
        ) : (
          <Grid container spacing={2}>
            {objects.map(obj => (
                ...
                <Card variant="outlined">
                  <CardContent>
                    ...
                    <Button 
                      ...
                      size="small"
                      sx={{ mt: 1 }}
                      onClick={() => navigate(`/${entityType}s/${entityId}/physics/objects/${obj.id}`)}
                    >
                      Edit
                    </Button>
                  </CardContent>
      ...
      {entityType === 'scene' && (
        <TabPanel value={tabValue} index={2}>
          <Typography variant="h6" gutterBottom>Physics Constraints</Typography>
          ...
          {constraints.length === 0 ? (
            <Typography>No physics constraints found. Constraints connect objects together with various joint types.</Typography>
          ) : (
            <Grid container spacing={2}>
                  ...
                  <Card variant="outlined">
                    <CardContent>
                      ...
                      <Button 
                        ...
                        size="small"
                        sx={{ mt: 1 }}
                        onClick={() => navigate(`/scenes/${entityId}/physics/constraints/${constraint.id}`)}
                      >
                        Edit
                      </Button>
                    </CardContent>

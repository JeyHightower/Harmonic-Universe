...
class TestEndToEnd:
    def test_complete_application_flow(self, client, auth_headers, test_user, socketio_client):
        ...
        get_response = client.get(f'/api/universes/{universe_id}', headers=user1_headers)
        ...
        # Search for universe
        search_response = client.get('/api/universes/search?q=E2E Test', headers=user1_headers)

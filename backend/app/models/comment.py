...
class Comment(db.Model):
    ...
    # Relationships
    universe = db.relationship('Universe', backref=db.backref('comments', lazy=True, cascade='all, delete-orphan'))
    ...
    def get_user_comments(user_id):
        ...
        return Comment.query.filter_by(user_id=user_id).order_by(Comment.created_at.desc()).all()

...
class AIModel(BaseModel):
    ...
    training_sessions = relationship(
        "TrainingSession", back_populates="model", cascade="all, delete-orphan"
    )
    inference_results = relationship(
        "InferenceResult", back_populates="model", cascade="all, delete-orphan"
    )
...
class TrainingSession(BaseModel):
    ...
    model_id = Column(
        UUID(as_uuid=True), ForeignKey("ai_models.id", ondelete="CASCADE")
    )

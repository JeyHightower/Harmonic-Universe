...
def expired_token_callback(jwt_header, jwt_data):
    ...
    current_app.logger.error(f"Expired token error - Header: {jwt_header}, Data: {jwt_data}")
    return jsonify({
        'status': 'error',
...
def user_lookup_error_callback(jwt_header, jwt_data):
    ...
    current_app.logger.error(f"User lookup error - Header: {jwt_header}, Data: {jwt_data}")
    return jsonify({
        'status': 'error',

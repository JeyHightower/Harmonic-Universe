...
from app.models import Universe, PhysicsParameters, MusicParameters, VisualizationParameters
...
class UniverseService:
    ...
    def update_universe(universe_id, data):
        ...
        if 'physics' in data:
            ...
            physics.particle_speed = data['physics'].get('particle_speed', physics.particle_speed)
        ...
        if 'visualization' in data:
            ...
            viz.color_scheme = data['visualization'].get('color_scheme', viz.color_scheme)
            viz.particle_size = data['visualization'].get('particle_size', viz.particle_size)

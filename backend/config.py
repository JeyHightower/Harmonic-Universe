...
class Config:
    ...
    # JWT settings
    JWT_SECRET_KEY = 'your-secret-key'  # Change this to your actual secret key
...
class DevelopmentConfig(Config):
    DEBUG = True
    SQLALCHEMY_DATABASE_URI = 'postgresql://postgres:postgres@localhost:5432/harmonic_universe'

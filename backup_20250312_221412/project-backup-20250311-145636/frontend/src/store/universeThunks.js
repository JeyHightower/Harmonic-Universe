...
export const fetchUniverses = createAsyncThunk(
  ...
  async (params = {}, { rejectWithValue }) => {
    try {
      ...
      const response = await apiClient.get(`/api/universes/?${queryParams.toString()}`);
      return response;
    } catch (error) {
...
export const fetchUniverseById = createAsyncThunk(
  ...
  async ({ id, includeScenes = false }, { rejectWithValue }) => {
    try {
      ...
      const response = await apiClient.get(`/api/universes/${id}?${queryParams.toString()}`);
      return response;
    } catch (error) {
      return rejectWithValue(error.response?.data || error.message);
    }
...
export const createUniverse = createAsyncThunk(
  ...
  async (universeData, { rejectWithValue }) => {
    try {
      const response = await apiClient.post('/api/universes/', universeData);
      return response;
    } catch (error) {
      return rejectWithValue(error.response?.data || error.message);
    }
...
export const updateUniverse = createAsyncThunk(
  ...
  async ({ id, ...updateData }, { rejectWithValue }) => {
    try {
      const response = await apiClient.put(`/api/universes/${id}`, updateData);
      return response;
    } catch (error) {
      return rejectWithValue(error.response?.data || error.message);
    }
...
export const deleteUniverse = createAsyncThunk(
  ...
  async (id, { rejectWithValue }) => {
    try {
      await apiClient.delete(`/api/universes/${id}`);
      return id;
    } catch (error) {
      return rejectWithValue(error.response?.data || error.message);
    }
...
export const fetchScenesForUniverse = createAsyncThunk(
  ...
  async (universeId, { rejectWithValue }) => {
    try {
      const response = await apiClient.get(`/api/universes/${universeId}/scenes`);
      return response;
    } catch (error) {
      return rejectWithValue(error.response?.data || error.message);
    }
...
export const updatePhysicsParams = createAsyncThunk(
  ...
  async ({ universeId, physicsParams }, { rejectWithValue }) => {
    try {
      const response = await apiClient.put(`/api/universes/${universeId}/physics`, {
...
export const updateHarmonyParams = createAsyncThunk(
  ...
  async ({ universeId, harmonyParams }, { rejectWithValue }) => {
    try {
      const response = await apiClient.put(`/api/universes/${universeId}/harmony`, {

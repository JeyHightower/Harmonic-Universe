...
def create_error_response(
    message, error_type, status_code, details=None, category=None, severity=None
):
    ...
    if current_app.debug:
        error_response["debug_info"] = {"error_type": error_type, "details": details}
...
def handle_websocket_error(error_type, details=None):
    ...
    error_messages = {
        "connection": {"message": "WebSocket connection error", "severity": "error"},
        "authentication": {
        ...
        "message": {"message": "Invalid message format", "severity": "warning"},
    }

    error_info = error_messages.get(
        error_type, {"message": "WebSocket error", "severity": "error"}
    )

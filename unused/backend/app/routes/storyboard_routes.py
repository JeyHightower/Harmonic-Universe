...
def create_storyboard(universe_id):
    ...
    try:
        ...
        return (
            jsonify(
                {"status": "success", "data": {"storyboard": storyboard.to_dict()}}
            ),
            201,
        )
    ...
    try:
        ...
        return (
            jsonify(
                {
                    "status": "success",
                    "data": {"storyboards": [s.to_dict() for s in storyboards]},
                }
            ),
            200,
        )
...
def get_storyboard_versions(storyboard_id):
    ...
    try:
        ...
        versions = (
            Version.query.filter_by(storyboard_id=storyboard_id)
...
def delete_storyboard(storyboard_id):
    ...
    try:
        ...
        return (
            jsonify(
                {"status": "success", "message": "Storyboard deleted successfully"}
            ),
            200,
        )
    except Exception as e:
